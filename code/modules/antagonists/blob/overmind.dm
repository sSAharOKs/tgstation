...
/mob/camera/blob/process()
	if(!blob_core)
		...
		priority_announce("Биологическая опасность достигла критической стадии. Потеря станции неизбежна.", "Предупреждение о биологической опасности")
	...
	if(announcement_time && (world.time >= announcement_time || blobs_legit.len >= announcement_size) && !has_announced)
		priority_announce("Подтверждена биологическая опасность 5-го уровня на борту [station_name()]. Весь персонал должен сдержать вспышку.", "Предупреждение о биологической опасности", ANNOUNCER_OUTBREAK5)
		has_announced = TRUE
