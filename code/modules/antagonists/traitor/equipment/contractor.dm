...
/datum/contractor_item/blackout/handle_purchase(datum/contractor_hub/hub)
	...
	if (.)
		power_fail(35, 50)
		priority_announce("Аномальная активность, обнаружена в электосети на [station_name()]. В качестве меры предосторожности питание станции будет отключено на неопределенный срок.", "Критическая ошибка в электросети", ANNOUNCER_POWEROFF)
