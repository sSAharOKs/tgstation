...
/datum/round_event/crystal_invasion/proc/choose_wave_type()
	...
	priority_announce("ВНИМАНИЕ - Многочисленные энергетические флуктуации были обнаружены от вашей Суперматерии; мы оцениваем что это [wave_name] кристаллических существ \
