...
/datum/round_event/ghost_role/blob/announce(fake)
	priority_announce("Подтверждена вспышка биологической опасности 5-го уровня на борту [station_name()]. Весь персонал должен сдержать распространение.", "Предупреждение о биологической опасности", ANNOUNCER_OUTBREAK5)
