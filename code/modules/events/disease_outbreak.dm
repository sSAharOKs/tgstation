...
/datum/round_event/disease_outbreak/announce(fake)
	priority_announce("Подтверждена вспышка биологической опасности 7-го уровня на борту [station_name()]. Весь персонал должен сдержать распространение.", "Предупреждение о биологической опасности", ANNOUNCER_OUTBREAK7)
