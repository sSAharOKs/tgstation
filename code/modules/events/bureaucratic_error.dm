...
/datum/round_event/bureaucratic_error/announce(fake)
	priority_announce("Недавняя бюрократическая ошибка в Отделе органических ресурсов может привести к нехватке персонала в некоторых отделах и избыточному штату в других.", "Предупреждение о неполадках с документами")
