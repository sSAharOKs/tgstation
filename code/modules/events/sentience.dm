...
/datum/round_event/ghost_role/sentience/announce(fake)
	...
	var/pets = pick("животных/ботов", "ботов/животных", "домашних животных", "простых животных", "Простейших животных", "\[ОТРЕДАКТИРОВАНО\]")
	var/strength = pick("человеческий", "скромный", "средний", "Охранный", "командный", "клоунский", "малый", "очень низкий", "\[ОТРЕДАКТИРОВАНО\]")

	sentience_report += "Основанный на [data], мы считаем, что [one] из [pets] развил(и) [strength] уровень интеллекта и умение общаться."
