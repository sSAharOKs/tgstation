...
/datum/round_event/aurora_caelus/announce()
	priority_announce("[station_name()]: Безвредное облако ионов приближается к вашей станции, они будут истощать свою энергию, колотя по корпусу.Компания Nanotrasen одобрила небольшой перерыв для всех сотрудников, чтобы расслабиться и понаблюдать за этим очень редким событием. В это время звездный свет будет ярким, но нежным, переходя от спокойного зеленого к голубому. Любой работник, который хотел бы сам увидеть эти огни, может пройти в ближайшую к ним зону с смотровыми иллюминаторами смотрящими в открытый космос. Мы надеемся, что вам понравится представление.",
