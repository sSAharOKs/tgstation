...
/obj/structure/checkoutmachine/Destroy()
	...
	priority_announce("Кредитный депозитный автомат в [get_area(src)] был уничтожен. Станционные фонды перестали истощаться!", sender_override = "Протокол CRAB-17")
...
/obj/effect/dumpeet_target/proc/startLaunch()
	...
	priority_announce("Кредитный пузырь лопнул! Доберитесь до кредитного депозитного автомата находящегося в [get_area(src)] и обналичьте деньги, прежде чем вы потеряете все свои средства!", sender_override = "Протокол CRAB-17")
